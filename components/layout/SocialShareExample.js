...
var SocialShare = require('NativeModules').SocialShare;
...
var ReactNativeSocialShare = React.createClass({
  ...
  shareOnKakaoTalk : function() {

    SocialShare.shareOnKakaoTalk({
        'text':'Global democratized marketplace for art',
        'link':'https://artboost.com/',
        'imagelink':'https://artboost.com/apple-touch-icon-144x144.png',
      },
  ...
  render: function() {
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight onPress={this.shareOnKakaoTalk}>
          <View style={{alignItems: 'center',justifyContent:'center', width: 150, height: 50,backgroundColor:'#ffdc00'}}>
           <Text style={{color:'#ffffff',fontWeight:'800',}}>Share on KakaoTalk</Text>
          </View>
        </TouchableHighlight>
      </View>
...
module.exports =  ReactNativeSocialShare;